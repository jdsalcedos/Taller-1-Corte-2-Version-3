...
# Palabras clave
# Palabras clave
keywords = {'if', 'else', 'while', 'return', 'for', 'int', 'float', 'bool', 'true', 'false', 'string', 'char', 'const'}
...
code_line = 'bool activo = !false;'
tokens = lexer(code_line)  # la función que usas para tokenizar
print(tokens)